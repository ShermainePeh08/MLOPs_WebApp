...
def get_user_input():
    ...
    # Postal Code
    postal_code = st.number_input("Postal Code", 000000)
    ...
    # Floor Area
    floor_area_sqm = st.number_input("Floor Area (sqm)", 10, step=10)
    ...
    cbd_dist = st.number_input("Distance from CBD (m)", 1000, step=1000)
    min_dist_mrt = st.number_input("Minimum Distance from MRT (m)", 100, step=100)
